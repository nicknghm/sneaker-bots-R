...
One of the other things we should add at this point is what sites the bots support. The main sites to consider are Shopify, Footsites (FootLocker, Eastbay, Chamos, FootAction), YeezySupply, Supreme, COllectibles (Funko), Retail (amazon, walmart). 
